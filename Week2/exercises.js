...
async function queryDatabase() {
   ...
   */
    ...
    */
    ...
    // The following code outputs exactly what was required in the task - show all contributors of each author.
    // However I wrote it in JS - not in SQL. I was thinking a couple of days how to translate this logic to SQL but I never came up with anything. Any Ideas?
    ...
    console.log('\nAll Authors and ALL their corresponding Collaborators');
